...
static const float TWIST_COVARIANCE[6] = {0.0001, 0.0001, 0, 0, 0, 0.0001};
...
constexpr float ACCEL_SCALING_FACTOR = 0.00059855;  // scaling factor to change mg to m/sec² // 0.0011971
